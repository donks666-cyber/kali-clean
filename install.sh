...
# Override bandwidth script with fixed version (shows 0 on first run instead of blank)
cp .config/i3blocks/bandwidth/bandwidth ~/.config/i3blocks/bandwidth/bandwidth
...
grep -q "zstyle ':omz:update' mode disabled" ~/.zshrc || echo "zstyle ':omz:update' mode disabled" >> ~/.zshrc
